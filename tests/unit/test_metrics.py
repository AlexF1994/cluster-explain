...
from cxplain.metrics import (EuclideanMetric, ManhattenMetric,
                             MetricNotImplementedError, get_distance_metric)
...
def test_get_distance_metric():
    assert isinstance(get_distance_metric("manhattan"), ManhattenMetric)
